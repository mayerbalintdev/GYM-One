...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_quantity'])) {
    ...
    if ($new_quantity > 0) {
        $update_sql = "UPDATE temp_cart SET quantity = $new_quantity WHERE id = $cart_id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete'])) {
    $cart_id = $_POST['cart_id'];
    $delete_sql = "DELETE FROM temp_cart WHERE id = $cart_id";
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format($row['price'], 2, '.', ' '); ?> <?php echo $currency; ?></td>
                                                    <td>
                                                        <form action="" method="POST">
                                                            <input type="number" name="quantity" value="<?php echo $row['quantity']; ?>" min="1" class="form-control" style="width: 60px;" required>
                                                    ...
                                                    <td>
                                                        <form action="" method="POST">
                                                            <input type="hidden" name="cart_id" value="<?php echo $row['cart_id']; ?>">
                                                            <button type="submit" name="delete" class="btn btn-danger btn-sm"><?php echo $translations["delete"]; ?></button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p><?= $modalpayertext; ?></p>
                    <p><?= $translations["invoiceamount"]; ?>: <?php echo $total; ?> <?php echo $currency; ?></p>
                    <form method="post">
                        <div class="form">
