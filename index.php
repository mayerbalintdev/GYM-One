        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-md-2 offset-md-1">
                    <h5 class="text-light mb-4"><?php echo $translations["payment-opt"];?></h5>
            ...
            <div class="border-top border-secondary pt-3 mt-3">
                <p class="small text-center mb-0">
                    Copyright © 2024 GYM One - All rights reserved. &nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                        width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314">
                        </path>
                    </svg>
                    - <a href="https://www.gymoneglobal.com/?lang=<?php echo $lang_code; ?>">GYM One Software</a>
                </p>
            </div>
        </div>
    </div>
